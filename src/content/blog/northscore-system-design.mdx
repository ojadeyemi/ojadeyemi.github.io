...
**Backend** — Two stateless services: FastAPI handles stats requests, Node.js serves as a headless CMS and content API. No session state, no sticky routing. When traffic spikes, containers scale horizontally. When traffic drops, they scale back down. I don't manage servers.
